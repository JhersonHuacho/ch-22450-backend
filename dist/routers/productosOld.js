...
var Producto_1 = __importDefault(require("../utilitario/Producto"));
// const Contenedor = require('../utilitario/fileSystem.ts');
var router = (0, express_1.Router)();
var objProducts = new Producto_1.default('db');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, objProducts.getAll()];
            case 1:
                response = _a.sent();
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, objProducts.getById(id)];
            case 3:
                response = _a.sent();
                if (response.status === 1) {
                    res.json({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                objQuery = req.query;
                isAdmin = Object.keys(objQuery).length === 0
                    ? false
                    : objQuery.admin === 'true' ? true : false;
                if (!isAdmin) return [3 /*break*/, 2];
                return [4 /*yield*/, objProducts.save(req.body)];
            case 1:
                response = _a.sent();
                if (response.status === 1) {
                    res.json({
...
router.put('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var objQuery, isAdmin, id, body, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                objQuery = req.query;
                ...
                id = req.params.id === undefined ? -1 : parseInt(req.params.id);
                body = req.body;
                return [4 /*yield*/, objProducts.updateById(body, id)];
            case 1:
                response = _a.sent();
                if (response.status === 1) {
                    res.json({
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var objQuery, isAdmin, id, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                objQuery = req.query;
                ...
                if (!isAdmin) return [3 /*break*/, 2];
                id = req.params.id === undefined ? -1 : parseInt(req.params.id);
                return [4 /*yield*/, objProducts.deleteById(id)];
            case 1:
                response = _a.sent();
                if (response.status === 1) {
                    res.json({
...
//# sourceMappingURL=productosOld.js.map